...
from .views import HomeView, PostView, AddPostView, UpdatePostView, DeletePostView, AddCategoryView, CategoryView, CategoryListView, CreateLikeView, AddCommentView, AboutView, ContactView, TagView
